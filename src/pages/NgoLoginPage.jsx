...
export default function NgoLoginPage(){
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-700 to-black
">
      <div className="bg-white p-8 rounded-2xl shadow max-w-md w-full">
        ...
        <form className="space-y-4">
          <input className="w-full px-4 py-2 border rounded" placeholder="Organization email" />
